...
c=`hexdump -ve '1/1 "%.2X"' $BLOB_ROOT/vendor/bin/hw/gpsd`; echo -n "$c" | sed 's/53534C76335F636C69656E745F6D6574686F6400/53534C7632335F6D6574686F6400000000000000/g' | xxd -r -p > $BLOB_ROOT/vendor/bin/hw/gpsd
